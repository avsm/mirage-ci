...
RUN cd /tmp && curl -OL https://test.docker.com/builds/Linux/x86_64/docker-1.13.0-rc5.tgz && tar -zxvf docker-1.13.0-rc5.tgz docker/docker && sudo mv docker/docker /usr/bin && rm -f docker-1.13.0-rc5.tgz
